...
const Navbar = () => {
  ...
  return (
    <ul
      className={`text-white fixed top-0 w-full py-6 px-6 lg:px-36 flex items-center justify-between text-lg z-[999999] transition-all lg:hover:backdrop-blur-lg ${
