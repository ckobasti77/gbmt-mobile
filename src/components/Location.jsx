...
const Location = () => {
  return (
    <div style={{ backgroundPosition: window.innerWidth < 1024 && '50% 50%' }} className="py-12 px-6 lg:px-36 min-h-screen  bg-[url(/./assets/images/bg-mirror2.png)] bg-no-repeat bg-left bg-cover">
